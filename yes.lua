...
-- give credit please, idc if u use it i just dont like being discredited ❤️
...
text.Text = " "..watermark.name.." | 0 FPS | Da Hood"

client_info.fps_changed(function(fps)
    text.Text = " "..watermark.name.." | " .. fps .. " FPS " " | " ..game.MarketplaceService:GetProductInfo(game.PlaceId).Name..
